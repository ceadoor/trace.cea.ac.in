...
SineWaveGenerator.prototype._resizeWidth = function() {
  ...
  // adjust these values to shift to L or R
  this.waveWidth = this.width * 0.78;
  this.waveLeft = this.width * 0.10;
};
...
SineWaveGenerator.prototype.drawSine = function(time, options) {
  ...
  // Center the waves
  var yAxis = this.height / 1.71;       // 2 initial
...
new SineWaveGenerator({
  ...
  resizeEvent: function() {
    ...
    gradient.addColorStop(0, "rgba(254, 255, 255, 0.01)");       //0 initial alpha
    gradient.addColorStop(0.5, "rgba(255, 255, 255, 0.6)");     //1 initial alpha
    gradient.addColorStop(1, "rgba(255, 255, 254, 0.02)");         //0 initial alpha
